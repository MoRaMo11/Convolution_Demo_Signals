...
funcF = Dreieck;
funcG = Rechteck;
/*___________________________________________ChangeFunc___________________________________________*/
changeFunction = function(value, id) {
        ...
        if (id == "functionList1") {
            ...
            board2.create('functiongraph', [funcG], ).setName("funcG");
        }
    }
...
board1.create('functiongraph', [funcF], { strokecolor: "#0000ff", strokewidth: 2, }).setName("funcF");
...
board2.create('functiongraph', [funcG], { strokecolor: "#ff0000", strokewidth: 2, }).setName("funcG");
